...
class RenderService {
  ...
  async renderPlaylist(
    ...
    // Use 44100Hz for better compatibility and slightly lower memory usage than 48k
    ...
    const bitrate = resolution === '1080p' ? 6_000_000 : 3_000_000; // Slightly reduced bitrate for stability
    ...
    const muxer = new Muxer.Muxer({
        ...
        // IMPORTANT: Disable fastStart (in-memory MOOV move) to prevent double memory usage at finalization
        fastStart: false 
    });
    ...
    audioEncoder.configure({
        ...
        sampleRate, 
        numberOfChannels: 2, 
        bitrate: 128_000 // Standard AAC bitrate
    });
